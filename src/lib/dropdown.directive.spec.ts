...
describe('DropdownToggleDirective', () => {
    ...
    it('should allow toggling dropdown from outside', () => {
        const template = `
            ...
            <div ngxsDropdown #drop="ngxsDropdown" (openChange)="openChange($event)"></div>
        `;
    ...
    it('should close if click outside', () => {
        fakeData.open = true;
        const fixture = createTestComponent('<button>Outside<button><div ngxsDropdown [open]="open"></div>');
        fixture.detectChanges();
        const element = fixture.debugElement.query(By.directive(DropdownDirective));
    ...
    it('should not close if click on toggle element', () => {
        const template = `
            <div ngxsDropdown [open]="open">
                <button ngxsDropdownToggle>Button</button>
                <p>Panel</p>
            </div>
        `;
        fakeData.open = true;
