...
describe('TreeviewComponent', () => {
    const baseTemplate = '<ngxs-treeview [items]="items" [config]="config" (selectedChange)="selectedChange($event)"></ngxs-treeview>';
    ...
    describe('no data binding', () => {
        ...
        beforeEach(fakeAsync(() => {
            fixture = createTestComponent('<ngxs-treeview></ngxs-treeview>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('null data binding', () => {
        ...
        beforeEach(fakeAsync(() => {
            fakeData.items = null;
            fixture = createTestComponent('<ngxs-treeview [items]="items"></ngxs-treeview>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('all items are collapsed but config has hasCollapseExpand=false', () => {
        ...
        beforeEach(fakeAsync(() => {
            ...
            fixture = createTestComponent('<ngxs-treeview [config]="config" [items]="items"></ngxs-treeview>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('config', () => {
        ...
        describe('hasAllCheckBox', () => {
            ...
            it('should display checkbox "All" if value is true', () => {
                ...
                const fixture = createTestComponent('<ngxs-treeview [config]="config" [items]="items"></ngxs-treeview>');
                fixture.detectChanges();
...
<ngxs-treeview [items]="items" [itemTemplate]="itemTemplate"></ngxs-treeview>`;
