...
describe('TreeviewComponent', () => {
    const baseTemplate = '<ngxs-dropdown-tree [items]="items" [config]="config" (selectedChange)="selectedChange($event)"></ngxs-dropdown-tree>';
    ...
    describe('no data binding', () => {
        ...
        beforeEach(fakeAsync(() => {
            fixture = createTestComponent('<ngxs-dropdown-tree></ngxs-dropdown-tree>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('null data binding', () => {
        ...
        beforeEach(fakeAsync(() => {
            fakeData.items = null;
            fixture = createTestComponent('<ngxs-dropdown-tree [items]="items"></ngxs-dropdown-tree>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('all items are collapsed but config has hasCollapseExpand=false', () => {
        ...
        beforeEach(fakeAsync(() => {
            ...
            fixture = createTestComponent('<ngxs-dropdown-tree [config]="config" [items]="items"></ngxs-dropdown-tree>');
            fixture.detectChanges();
            tick();
        }));
    ...
    describe('config', () => {
        ...
        describe('hasAllCheckBox', () => {
            ...
            it('should display checkbox "All" if value is true', () => {
                ...
                const fixture = createTestComponent('<ngxs-dropdown-tree [config]="config" [items]="items"></ngxs-dropdown-tree>');
                fixture.detectChanges();
        ...
        describe('maxHeight', () => {
            it('should display style correct max-height value', () => {
                ...
                expect(container.nativeElement.getAttribute('style')).toEqual({ 'max-height': '400px' });
            });
        });
    ...
    describe('template', () => {
        ...
        // </ng-template>
        // <ngxs-dropdown-tree [items]="items" [itemTemplate]="itemTemplate"></ngxs-dropdown-tree>`;
